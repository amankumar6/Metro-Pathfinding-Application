...
public class Graph_M {
 ...
 /*
    ...
    public static void Create_Metro_Map(Graph_M g) {
        ...
        g.addVertex("S R Nagar");
        g.addVertex("Ameerpet");
        g.addVertex("Punjagutta");
        g.addVertex("Irrum Manzil");
        g.addVertex("Khairatabad");
        g.addVertex("Lakdi-ka-pul");
        ...
        g.addVertex("LB Nagar");

        g.addEdge("Miyapur", "JNTU College", 8);
        g.addEdge("JNTU College", "KPHB Colony", 5);
        g.addEdge("KPHB Colony", "Kukatpally", 6);
        g.addEdge("Kukatpally", "Balanagar", 12);
        g.addEdge("Balanagar", "Moosapet", 7);
        g.addEdge("Moosapet", "Bharat Nagar", 4);
        g.addEdge("Bharat Nagar", "Erragadda", 8);
        g.addEdge("Erragadda", "ESI Hospital", 9);
        g.addEdge("ESI Hospital", "S R Nagar", 6);
        g.addEdge("S R Nagar", "Ameerpet", 9);
        g.addEdge("Ameerpet", "Punjagutta", 12);
        g.addEdge("Punjagutta", "Irrum Manzil", 4);
        g.addEdge("Irrum Manzil", "Khairatabad", 7);
        g.addEdge("Khairatabad", "Lakdi-ka-pul", 8);
        g.addEdge("Lakdi-ka-pul", "Assembly", 10);
        g.addEdge("Assembly", "Nampally", 11);
        g.addEdge("Nampally", "Gandhi Bhavan", 7);
        g.addEdge("Gandhi Bhavan", "Osmania Medical College", 6);
        g.addEdge("Osmania Medical College", "MG Bus Station", 8);
        g.addEdge("MG Bus Station", "Malakpet", 9);
        g.addEdge("Malakpet", "New Market", 4);
        g.addEdge("New Market", "Musarambagh", 8);
        g.addEdge("Musarambagh", "Dilsukhnagar", 13);
        g.addEdge("Dilsukhnagar", "Chaitanyapuri", 15);
        g.addEdge("Chaitanyapuri", "Victoria Memorial", 14);
        g.addEdge("Victoria Memorial", "LB Nagar", 7);
    }
